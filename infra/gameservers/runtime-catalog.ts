...
export const GAME_RUNTIMES: GameRuntime[] = [
  ...
  },
  {
    ...
    notes: "TYPE=SPIGOT; Paper ile aynı imaj ailesi ama kendi derlemesini yapar, ilk açılış daha uzun sürer. Ölçülmedi.",
  },
  {
    gameId: "minecraft",
    softwareId: "forge",
    ...
    dataPath: "/data",
    readinessPattern: 'Done \\([0-9.]+s\\)! For help, type "help"',
    // Mod platforms carry a far larger heap than a plugin server; 2 GB is not
    // enough for a loaded pack, so the floor is declared a plan higher.
    minimumMemoryMb: 4096,
    verification: "declared",
    notes: "TYPE=FORGE; mod platformu, bellek profili eklenti sunucusundan ağır. Sürüm uyumu ve açılış süresi ölçülmedi.",
  },
  {
    gameId: "minecraft",
    softwareId: "neoforge",
    ...
    minimumMemoryMb: 4096,
    verification: "declared",
    notes: "TYPE=NEOFORGE; Forge'un güncel çatalı. Yeni Minecraft sürümlerinde mod platformları gecikebilir; sürüm uyumu ölçülmeli.",
  },
  {
    gameId: "minecraft",
    softwareId: "quilt",
    ...
    minimumMemoryMb: 2048,
    verification: "declared",
    notes: "TYPE=QUILT; Fabric ile aynı hafiflik beklenir ama ayrı yükleyici, ölçülmedi.",
  },
  {
    gameId: "terraria",
